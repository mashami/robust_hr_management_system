...
const OverviewItem = ({ text, totalNumber, svg }: OverviewItemType) => {
  return (
    <div className="px-4 py-6 bg-white rounded-lg relative w-full">
      <div className="absolute -top-5 -left-6 flex items-center justify-center w-[76px] h-[82px] bg-white border border-black/30 rounded-[30px] text-2xl text-[#071C50] font-semibold">
        {totalNumber}
      </div>
